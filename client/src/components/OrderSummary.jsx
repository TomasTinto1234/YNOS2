    ...
    <View style={styles.conteiner}>
      ...
      <View style={styles.pedidos}>
        <View style={styles.line}>
          ...
          <Text style={styles.textMoney}>$ .{subTotal?.toFixed(2)}</Text>
        </View>
        <View style={styles.line}>
          <Text style={styles.text}>Propina</Text>
          <Text style={styles.textMoney}>$ .{tip?.toFixed(2)}</Text>
        </View>
        <View style={styles.line}>
          <Text style={styles.text}>Cupon de Descuento</Text>
          <Text style={styles.textMoney}>$ .{coupon?.toFixed(2)}</Text>
        </View>
        <View style={styles.line}>
          <Text style={styles.text}>Tarifa de servicio</Text>
          <Text style={styles.textMoney}>$ .{serviceFee?.toFixed(2)}</Text>
        </View>
        <View style={styles.line}>
          <Text style={styles.textTotal}>Total a Pagar</Text>
          <Text style={styles.textMoneyTotal}>$ .{total?.toFixed(2)}</Text>
        </View>
      </View>
    </View>
  )
